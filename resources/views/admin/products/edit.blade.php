    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <form method="post" action="{{ url('/admin/products/'. $product->id.'/edit') }}">
                ...
                <textarea class="form-control" placeholder="Descripción extensa de producto" rows="5" name="long_description">{{ old('long_description', $product->long_description) }}</textarea>
